      ...
      <div className='container'>
        <div className="row gy-4">
          ...
          <div className="col-12 col-md-4 footer-contact">
            ...
            <p>
              ...
              <strong>{t('footer.phone')}:</strong> +256 750 274 516<br />
              <strong>{t('footer.email')}:</strong> <a href="mailto:norrechel@gmail.com">norrechel@gmail.com</a>
            </p>
          </div>
          ...
          <div className="col-12 col-md-4 footer-links">
            ...
            <ul className="list-unstyled footer-link">
              <li><i className="bx bx-chevron-right"></i> <Link to="/web-design">{t('footer.serviceWebDesign')}</Link></li>
              <li><i className="bx bx-chevron-right"></i> <Link to="/mentorship">{t('footer.serviceMentorship')}</Link></li>
              <li><i className="bx bx-chevron-right"></i> <Link to="/business-consulting">{t('footer.serviceBusinessConsulting')}</Link></li>
            </ul>
          </div>
        ...
        <div className="row">
          <div className="col-12 text-center pt-3">
            &copy; {new Date().getFullYear()} <span className="fw-bold">Norrechel</span>. {t('footer.rightsReserved')}
          </div>
        </div>
      </div>
    </footer>
